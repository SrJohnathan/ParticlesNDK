...
bool EffekseerEffectCore::Load(Effekseer::Manager *maneger, const unsigned char *data, int len, float magnification) {

    ES_SAFE_RELEASE(effect_);

    effect_ = ::Effekseer::Effect::Create(maneger, (void *) data, len, magnification);
